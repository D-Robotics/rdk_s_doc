...
- **tros.b robotics middleware**: TogetheROS.Bot based on ROS/ROS2, preinstalled in the image (see [Using TogetheROS.Bot](./01_Quick_start/04_next_steps/02_trosb.md)).
