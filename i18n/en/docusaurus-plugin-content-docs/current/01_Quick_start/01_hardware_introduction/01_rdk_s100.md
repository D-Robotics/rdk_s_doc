...
- USB download interface. The download interface provided by the RDK S100 development board is used for firmware download. For details, please refer to [1.2 System Flashing](../03_install_os_and_setup/rdk_s100/01_instruction.md)
