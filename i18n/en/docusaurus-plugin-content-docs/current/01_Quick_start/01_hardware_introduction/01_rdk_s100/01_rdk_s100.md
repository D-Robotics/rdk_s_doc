...
- USB download interface. The download interface provided by the RDK S100 development board is used for firmware download. For details, please refer to [1.2 System Flashing](../../02_install_os/rdk_s100/02_preparation.md)
...
2. Note the [USB 2.0 Camera Access Limitation](/Basic_Application/Image/usb_camera#usb-2.0-note).
   :::
...
<img src="https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/hardware_interface/sw1-2-en.png" alt="switch" width="70%" />

| Ref. | Name     | Description           | Usage                                    |
| ---- | -------- | --------------------- | ---------------------------------------- |
| SW1  | ON/OFF   | Power switch          | Downward toggle: Power on<br/>Upward toggle: Power off                       |
| SW2  | DOWNLOAD | DFU flashing mode switch | Downward toggle: Normal boot mode<br/>Upward toggle: Enable flashing mode|
