...
- USB download interface. The download interface provided by the RDK S600 development board is used for firmware download. For details, please refer to [1.2 System Flashing](/Quick_start/install_os/rdk_s600)
