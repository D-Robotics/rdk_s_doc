...
# RDK S600 V0P1
<img src="https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/hardware_interface/image-rdk_600_v0p1_mainboard_overview.png" alt="RDK S600 V0P1" style={{ width: '100%', maxWidth: '980px', height: 'auto', display: 'block', margin: '0 auto' }} />
...
<img src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/hardware_interface/image-rdk_s600_architecture_diagram.png" alt="Topology Diagram" style={{ width: '100%', maxWidth: '980px', height: 'auto', display: 'block', margin: '0 auto' }} />

### Interface Diagram

<!-- **V0P1 Interface Diagram:** -->

<img src="https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/hardware_interface/image-rdk_s600_v0p1_mainboard_interface_V0P1.png" alt="Interface Diagram" style={{ width: '100%', maxWidth: '980px', height: 'auto', display: 'block', margin: '0 auto' }} />

<!-- **V0P2 Interface Diagram:**
<img src="https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/hardware_interface/image-rdk_s600_v0p1_mainboard_interface.png" alt="Interface Diagram" style={{ width: '60%', maxWidth: '980px', height: 'auto', display: 'block', margin: '0 auto' }} /> -->
...
Interface Definition: <a href="https://archive.d-robotics.cc/downloads/hardware/rdk_s600/rdk_s600/D-Robotics_RDK_S600_Connector_Application_Note_V0P1-20260922_EN.xlsx">D-Robotics_RDK_S600_Connector_Application_Note_V0P1.xlsx</a>
...
- USB download interface. The download interface provided by the RDK S600 development board is used for firmware download. For details, please refer to [1.2 System Flashing](/Quick_start/install_os/rdk_s600/burn)
...
- Note the [USB 2.0 Camera Access Limitation](/Basic_Application/Image/usb_camera#usb-2.0-note).
  :::
...
<div className="latest-version-fab-wrap">
  <a className="latest-version-fab" href="/rdk_s_doc/en/01_Quick_start/01_hardware_introduction/02_rdk_s600/01_rdk_s600_kit">Back to Latest V1P0</a>
</div>