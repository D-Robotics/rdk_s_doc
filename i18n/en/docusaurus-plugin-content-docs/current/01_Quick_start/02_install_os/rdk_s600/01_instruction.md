...
The RDK S600 development kit can use the PC-side tool Xburn to flash the Ubuntu system.
...
1.  **Product Type:** Please select the product type corresponding to the device you want to flash.
    ...
    - Each product type corresponds to a specific hardware model or configuration (e.g., RDKS600).
