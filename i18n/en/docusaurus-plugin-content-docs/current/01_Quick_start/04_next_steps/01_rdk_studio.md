...
| Demo management | Built-in management of RDK sample projects; run [algorithm demos](../../03_Demos/03_algorithm_demo/01_summary.md) with one click |

## Comparison with Manually Setting Up a Development Environment

| Aspect | RDK Studio | Manual setup ([5.1.1](../../07_Advanced_development/06_environment_build/01_environment_build.md)) |
| --- | --- | --- |
...
- [Algorithm Toolchain Development Guide](../../07_Advanced_development/10_algorithm_toolchain/01_algorithm_toolchain/01_overview.md)
