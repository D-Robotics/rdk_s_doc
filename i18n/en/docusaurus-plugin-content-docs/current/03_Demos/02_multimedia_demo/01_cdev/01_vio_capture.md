...
- **Execution Method:**
  ...
  - `-b`: Bit depth of the RAW image. For example, IMX219 supports RAW10 format, so the bit depth is 10. Refer to the [Accessory List](/01_Quick_start/01_hardware_introduction/01_rdk_s100/01_rdk_s100_kit#配件清单) for supported sensor formats.
