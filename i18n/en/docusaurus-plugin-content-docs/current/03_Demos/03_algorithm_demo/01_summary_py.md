...
#### Other Components
- hbm_runtime: Loads and runs `.hbm` models. Installed by default on the system. For manual installation, see the [Python API](../../04_Simple_API/02_inference_api/01_python_api.md#module-class-and-function-reference-api-reference) section.
