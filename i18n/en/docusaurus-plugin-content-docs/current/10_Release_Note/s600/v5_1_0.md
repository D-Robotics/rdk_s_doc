...
#### 2.2.4 Log
- Kernel log storage changed to be maintained by Ubuntu's native rsyslog. Refer to [documentation](/Advanced_development/linux_development/log_introduction#log-content) for detailed description.
