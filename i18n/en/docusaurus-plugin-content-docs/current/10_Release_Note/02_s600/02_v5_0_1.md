...
- Added support for TA development without relying on OP-TEE source code.
...
- Added eth PPS interrupt registration function, supporting configuration of eth PPS as trigger source for timesync_sample;
