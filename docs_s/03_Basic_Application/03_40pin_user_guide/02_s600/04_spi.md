...
RDK S600 在 14-PIN自锁接口上引出了 `SPI1` 总线，支持一个片选，IO 电压 1.8V；
...
![image-rdk_s600_spi.png](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/03_Basic_Application/03_40pin_user_guide/image/40pin_user_guide/image-rdk_s600_spi.png)
