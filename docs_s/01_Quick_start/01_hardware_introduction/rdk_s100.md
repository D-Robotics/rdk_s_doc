...
RDK S100开发套件由SOM核心模组、Mainboard底板，CAM扩展板、MCU扩展板四部分组成。提供了以太网口、USB、HDMI、MIPI CSI、30PIN等多种外围接口，方便用户对RDK S100开发套件进行功能体验、开发测试等工作。
...
RDK S100开发板提供了四路PCIE拓展出来的USB3.0标准接口（接口6），可以满足4路USB外设同时接入使用。需要注意的是，RDK S100 PCIE拓展的USB接口只支持Host模式。
