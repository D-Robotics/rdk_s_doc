...
- 请参考各个板卡对应[MIPI摄像头](../01_Quick_start/01_hardware_introduction/rdk_s100.md)章节，确认摄像头连接方式
...
- 支持的分辨率类型，可参考各个板卡对应[HDMI接口](../01_Quick_start/01_hardware_introduction/rdk_s100.md)章节
