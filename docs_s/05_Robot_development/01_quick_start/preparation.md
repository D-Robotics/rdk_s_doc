...
- **系统版本号查看方法以及详细说明，请查看[FAQs](/docs_s/08_FAQ/03_applications_and_examples.md)。**
:::
...
体验和开发过程中经常需要使用scp/ssh等命令通过IP地址访问RDK，因此这里推荐使用动态配置，参考[网络配置](/docs_s/02_System_configuration/01_network_blueteeth.md)
