...
S100 开发板将Uart5引出供用户开发学习使用，PIN脚位于`Main Board`板上的`MCU Expansion Header(J22)`。
...
S600 开发板将Uart10和Uart11引出供用户开发学习使用，PIN脚位于`Main Board`板上上的`2x UART(MAIN)/2x UART(MCU)(J18)`
