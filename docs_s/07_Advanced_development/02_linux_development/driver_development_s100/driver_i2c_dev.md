...
``` {.text}
root@hobot:/# cat /sys/kernel/debug/dw_i2c0/registers
...
root@hobot:~# cat /sys/kernel/debug/dw_i2c0/fifodump
...
``` {.text}
root@hobot:~# echo 01 02 > /sys/kernel/debug/dw_i2c0/whitelist
root@hobot:~# cat /sys/kernel/debug/dw_i2c0/whitelist
whitelist: 01 02
```
