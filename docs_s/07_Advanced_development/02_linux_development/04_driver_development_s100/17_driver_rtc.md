...
在 S100/S600 芯片中，内置了一个 RTC 模块，该模块是可配置高精度计数器，能够为系统提供稳定的时间基准。此外，S100/S600 还外置了一个 YSN8130E 模块，该模块支持外部电池供电，从而在系统断电时仍能保持时间的连续性。
