...
![](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/47d116e8a1208f63ffc3bd6877931046.jpg)
...
| RDK-S100                       | MIPI host    | I2C   | gpio1                             | gpio2                             | 其他                                                            | [../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image2.png](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image2.png) |
|--------------------------------|--------------|-------|-----------------------------------|-----------------------------------|-----------------------------------------------------------------|--------------------------------------|
| RX0 (丝印 J1) 可接 imx219 模组 | **0** 4 lane | **2** | SENSOR0_GPIO1 **SENSOR0_ERR 444** | SENSOR0_GPIO2 **SENSOR2_ERR 446** | 注意： imx219 模组本身外接 24M 晶振，所以不需要 SOC 端输出 mclk |                                      |
| RX1 (丝印 J6) 可接 imx219 模组 | **1** 4 lane | **3** | SENSOR1_GPIO1 **SENSOR1_ERR 445** | SENSOR1_GPIO2 **SENSOR3_ERR 447** | 注意： imx219 模组本身外接 24M 晶振，所以不需要 SOC 端输出 mclk |                                      |
| RX2 用于接 serdes              | **2** 4 lane | **4** | 暂无介绍                          | 暂无介绍                          | 解串器 max96712, addr: 0x29 poc: max20087, addr: 0x28           |                                      |

硬件连接示意图：

| [../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image3.png](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image3.png) | [../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image4.png](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image4.png) |
|--------------------------------------|--------------------------------------|
...
![](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/8610116a72091d2dbf142b46faab8595.png)
...
-   通过 echo 命令进行控制 sensor 上电或者 reset （注：该说明使用 imx219
    模组无需操作 gpio）
...
echo 444 > /sys/class/gpio/unexport
```


-   使用 i2cdetect 检测 sensor i2c
    地址。如果检测到正确的地址，如下图所示，则表示 dts 配置正确，否则需要检查
    dts 配置。

| [../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image6.png](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image6.png) | [../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image7.png](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/image7.png) |
|--------------------------------------|--------------------------------------|
...
修改 tools/viotool/tuning_tool/scripts/tuning_menu.sh 文件，仿照已有的
sensor，进行添加。
...
在 tools/viotool/tuning_tool/cfg/matrix 目录下建立 tuning_imx219_cim_isp_1080p
...
![](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/9452fb95d12f60de21feed4c68844774.png)
...
进入tuning 目录，cd /app/utils/tuning_tool/control_tool
...
![](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/5e0359f4cc7eaf63841d15bc50e23bfd.png)

脚本会自动识别板子ip, 默认检查eth1网卡ip地址。若需要修改为启动eth0
网卡，修改脚本eth_id=eth0。修改位置如图所示。

![](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/cf74617238fd1bc29789802ef78b4659.png)

修改通信地址示意图

![](../../../../static/img/07_Advanced_development/03_multimedia_development/02_S100/camera_bringup/7c2486016a7d3a4feab194aea1eb3a3d.png)
