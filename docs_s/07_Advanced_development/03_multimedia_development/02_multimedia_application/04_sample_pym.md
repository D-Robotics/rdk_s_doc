...
### 运行效果
以输入分辨率为 1920 x 1080 的 YUV 图片为例，执行 `./sample_pym -i  ../sample_stitch/nv12_1920x1080.yuv -w 1920 -h 1080`。
...
Using input file:../sample_stitch/nv12_1920x1080.yuv, input:1920x1080
(read_yuvv_nv12_file):file read(../sample_stitch/nv12_1920x1080.yuv), y-size(2073600)
