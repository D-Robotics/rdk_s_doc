...
# 2.3 config.txt 文件配置
:::info 注意
`config.txt`配置文件仅适用于`RDK X3`、`RDK X5`和`RDK X3 Module`开发板，不适用于`RDK Ultra`和`RDK S100`开发板
:::
<!--
...
1. `config.txt`配置文件仅适用于`RDK X3`、`RDK X5`和`RDK X3 Module`开发板，不适用于`RDK Ultra`和`RDK S100`开发板。
