...
URL: https://developer.d-robotics.cc/rdk_s_doc/Advanced_development/multimedia_development/multimedia_application/sample_vin
...
| 目录 | 描述 
| get_vin_data | 单路 sensor 获取视频帧示例 
| get_multi_vin_data | 多路 sensor 获取视频帧示例 
