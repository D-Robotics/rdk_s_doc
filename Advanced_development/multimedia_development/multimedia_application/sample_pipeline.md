...
URL: https://developer.d-robotics.cc/rdk_s_doc/Advanced_development/multimedia_development/multimedia_application/sample_pipeline
...
| single_pipe_vin_isp_ynr_pym_gdc | 单路 sensor pipeline 串联 GDC 变换示例 
| single_pipe_vin_isp_ynr_pym_gdc_vpu | 单路 sensor pipeline 串联 GDC 变换示例并编码示例 
