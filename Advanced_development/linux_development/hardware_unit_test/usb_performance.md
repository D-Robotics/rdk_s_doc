...
URL: https://developer.d-robotics.cc/rdk_s_doc/Advanced_development/linux_development/hardware_unit_test/usb_performance
...
![S100_USB2.0](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/images_to_upload/S100_USB2.0.png)**2.** 将 USB 2.0 虚拟为网口，命令如下：
...
![RNIS_Device](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/images_to_upload/RNIS_Device.png)**3.** 使用以下命令来配置 usb0 网络接口的 IP 地址，使其与 PC 端远程网卡的 IP 地址网段一致。
