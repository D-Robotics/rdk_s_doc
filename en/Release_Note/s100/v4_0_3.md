...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Release_Note/s100/v4_0_3
...
- 参考 [1.2 系统烧录](/rdk_s_doc/en/01_Quick_start/02_install_os/rdk_s100/01_instruction.md) 章节完成烧录
...
- 参考 [1.2 系统烧录](/rdk_s_doc/en/01_Quick_start/02_install_os/rdk_s100/01_instruction.md) 章节 uboot 烧录章节进行基础配置
- 在上述配置中更改部分选项：
