...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/linux_development/kernel_debug
...
**It is recommended to create a dedicated partition for ramdump. See [Custom Partition Instructions](/rdk_s_doc/en/Advanced_development/rdk_gen#Custom-Partition-Instructions) , for example, name the partition "ramdump".**
