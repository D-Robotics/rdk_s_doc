...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/linux_development/driver_development_super/driver_hbmem/s100_hbmem_FAQ
...
- Q: When using a memory pool, is it necessary to  預先 estimate the total memory required and reserve it at the application layer?
