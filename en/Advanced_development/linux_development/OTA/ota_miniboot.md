...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/linux_development/OTA/ota_miniboot

note

- This upgrade method is only applicable to **non-OTA** images for online miniboot updates. For OTA images, please follow the complete [System OTA Upgrade](/rdk_s_doc/en/Advanced_development/linux_development/OTA/ota_system) process.
...
Refer to the Update miniboot entry in [srpi-config](/rdk_s_doc/en/System_configuration/srpi-config#system-options) .
