...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/linux_development/hardware_unit_test/10-3d_gpu
...
3. On the login screen, click the small gear icon in the bottom-right corner and select either the GNOME or Ubuntu (Wayland) session.
4. The program outputs via HDMI to the monitor, allowing you to visually observe the 3D GPU rendering performance.
5. Run `glmark2-es2-wayland` .
6. The following results will be printed:
