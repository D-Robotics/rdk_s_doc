...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/linux_development/hardware_unit_test/wifi_performance
...
2. Go to the [iperf official website](https://iperf.fr/iperf-download.php) to download the installation package suitable for your operating system.
3. On Windows, open Command Prompt (cmd) and run the following command to start the server:
