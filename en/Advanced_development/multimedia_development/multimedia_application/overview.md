...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/multimedia_development/multimedia_application/overview
...
1. Depends on Sensor configuration files in the `/app/multimedia_samples/vp_sensors` directory. File references are specified in `/app/multimedia_samples/Makefile.in` as follows:
