...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/multimedia_development/multimedia_application/sample_pipeline
...
| single_pipe_vin_isp_ynr_pym_vpu | Example of a simple single-sensor pipeline concatenated with encoding 
| single_pipe_vin_isp_ynr_pym_gdc | Example of a single-sensor pipeline concatenated with GDC transformation 
| single_pipe_vin_isp_ynr_pym_gdc_vpu | Example of a single-sensor pipeline concatenated with GDC transformation and encoding 
| multi_pipe_vin_isp_ynr_pym_gdc_vpu | Example of a multi-sensor pipeline concatenated with encoding 
