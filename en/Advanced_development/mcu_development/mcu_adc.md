...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/mcu_development/mcu_adc
...
**instance:** ADC instance number (required) **ch_num:** ADC channel number (required)
