...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/mcu_development/mcu_ethercat
...
4. `0x001B` : Invalid mailbox configuration
5. `0x001D` : Invalid SM configuration
6. `0x001E` : Invalid SM3 configuration (outputs)
