...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/mcu_development/mcu_timer
...
- load: Timer reload value (initial count), valid only for the on operationOn S100, the default clock frequency is 200 MHz. The relationship between clock frequency and load value is:
...
![](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/07_Advanced_development/05_mcu_development/01_S100/mcu_timer_case1.png)**Example 2** : Start the timer with a 100 us periodic interrupt
...
![](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/07_Advanced_development/05_mcu_development/01_S100/mcu_timer_case2.png)**Example 3** : Start the timer and read the current remaining count value
