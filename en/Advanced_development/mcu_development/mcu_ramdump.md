...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/mcu_development/mcu_ramdump
...
![](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/07_Advanced_development/05_mcu_development/01_S100/mcu_ramdump_flowchart-en.jpg)The exception handling flows for MCU0 and MCU1 are largely similar; the only difference is that MCU0 restarts the system after handling the exception.
...
![](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/07_Advanced_development/05_mcu_development/01_S100/mcu_ramdump_exception.png)The meaning of each field is as follows:
...
- Arrow 6 indicates the address information where the crash dump was recorded when the exception occurred. You can enter `dumpmem [addr] 4 64` in the MCU shell to read the register and stack information saved at the crash site, or obtain the register and stack information from the A-core via sysfs .
