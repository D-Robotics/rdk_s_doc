...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Advanced_development/mcu_development/mcu_uart
...
![image-rdk_100_mainboard](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/hardware_interface/image-rdk_100_mainboard_interface.png) tip
...
- `uarttest 2` Receive data Here, a serial assistant (configuration: 921600 baud rate 8-N-1) is used to send data to the MCU
...
- `uarttest 2` Receive data, test UART receive function Here, a serial assistant (configuration: 921600 baud rate 8-N-1) is used to send data to the MCU
