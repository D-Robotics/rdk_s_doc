...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Quick_start/remote_login
...
- [rdk_s100 Debug Serial Port Section](/rdk_s_doc/en/Quick_start/hardware_introduction/rdk_s100/#type-c-j16)

- [rdk_s600 Debug Serial Port Section](/rdk_s_doc/en/Quick_start/hardware_introduction/rdk_s600/rdk_s600#flash-connect-burn-mainmcu-debug-j4)
...
2. Verify connection to the development board![image-S100-download](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/install_os/image-mac-usb-driver-minicom-success.png)
tip
If you experience garbled text when using minicom, please refer to [Garbled text on serial port using macOS system laptop](/rdk_s_doc/en/Quick_start/install_os/rdk_s100/FAQ#garbled-text-on-serial-port-using-macos-system-laptop)
...
![image-20220416110242445](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/remote_login/image-s100-pc-static-ip.png)If you need to configure the development board's wired network to DHCP mode for dynamic acquisition, refer to the [Wired Network](/rdk_s_doc/en/System_configuration/network_bluetooth) section.
...
tip
The NoMachine feature requires software package support on the S100/S600 side. See [NoMachine Configuration](/rdk_s_doc/en/Quick_start/configuration_wizard/configuration_wizard_s100#nomachine-configuration) for configuration guidance.
...
![nomachine_login04](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/remote_login/image-S100-nomachine_login04.jpg)![nomachine_login05](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/remote_login/image-S100-nomachine_login05.jpg)
