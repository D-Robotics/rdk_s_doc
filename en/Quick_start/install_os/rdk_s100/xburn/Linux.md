...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/Quick_start/install_os/rdk_s100/xburn/Linux
...
4. If the `DOWNLOAD` LED lights up, the device is in DFU mode. Otherwise, press the `K1` button to reset the system. ![](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/07_Advanced_development/05_mcu_development/01_S100/basic_information/board_dfu1-en.jpg)
**Flashing with Xburn**
...
- Click `Start Upgrade` . The device will enter Fastboot mode. Wait for the process to complete. ![](https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/install_os/image-S100-xburn-burn_progress-en.png)
