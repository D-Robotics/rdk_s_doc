...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/System_configuration/srpi-config
...
If you need to upgrade Miniboot-related partitions, you can perform operations in this option. For the specific upgrade principle and partitions involved in the upgrade, please refer to: [Miniboot Upgrade](/rdk_s_doc/en/Advanced_development/linux_development/OTA/ota_miniboot) .
...
It is recommended to refer to [config.txt File Configuration](/rdk_s_doc/en/System_configuration/config_txt) for peripheral configuration;
