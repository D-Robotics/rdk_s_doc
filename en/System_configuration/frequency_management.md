...
URL: https://developer.d-robotics.cc/rdk_s_doc/en/System_configuration/frequency_management
...
info
PS: The above settings are only valid for the current boot, and need to be **re** set after reboot .
