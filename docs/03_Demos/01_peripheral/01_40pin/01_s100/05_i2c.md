...
RDK S100 在 40-pin 上默认使能 I2C5（物理管脚号 3 和 5）和 I2C4（物理管脚号 27 和 28），IO 电压 3.3V。

:::info

- 40-pin 上需要拨动拨码开关来选择使用 I2C5 还是 UART2, 具体细节可以查看下图：

<!-- TODO(F1): uart/i2c 示意图复用 audio3.png 疑错，待换正确原理图 -->
<img src="https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/07_Advanced_development/02_linux_development/driver_development_s100/audio3.png" alt="I2C 应用示意图" style={{ width: '40%', maxWidth: '980px', height: 'auto', display: 'block', margin: '0 auto' }} />
...
- [I2C 调试指南](../../../../07_Advanced_development/04_driver_development/03_driver_i2c_dev.md)
