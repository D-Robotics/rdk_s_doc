...
description: "RDKS100_LNX_SDK_V4.0.2 版本发布说明"
---
...
- Ubuntu 22.04 Desktop Based D-Robotics 定制系统
  - 支持 RDK 专属命令
...
专为机器人端侧推理场景设计的轻量级推理框架，简化算法模型的部署流程，充分释放 BPU 算力，降低 AI 算法在板端应用的技术门槛。
...
面向机器人厂商及生态开发者提供的预训练 AI 算法库，助力在 D-Robotics RDK 系统上快速集成和部署多种视觉与感知模型。涵盖以下模型类别：
