...
- 参考[1.2 系统烧录](../../01_Quick_start/03_install_os_and_setup/rdk_s100/01_instruction.md)章节完成烧录
...
- 参考[1.2 系统烧录](../../01_Quick_start/03_install_os_and_setup/rdk_s100/01_instruction.md)章节 uboot 烧录章节进行基础配置
- 在上述配置中更改部分选项：
  - 升级配置：分区选择
