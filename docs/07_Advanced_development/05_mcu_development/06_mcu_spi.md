...
1. 初始化
    - 修改 `ChannelCfgArrayPtr` , `JobCfgArrayPtr` , `SeqCfgArrayPtr` , `HwCfgPtr` , `PhyCfgPtr` 等配置结构体，将 SPI 对应 instance 配置为自己需要的波特率和传输模式，可参考 SPI 配置说明[Spi 配置说明](./06_mcu_spi.md#spi_config)
