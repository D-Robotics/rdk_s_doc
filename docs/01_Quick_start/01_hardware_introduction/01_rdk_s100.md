...
地瓜机器人 RDK S100 系列开发者套件搭载 S100 智能计算芯片，BPU 可提供高达 80/128 TOPS 的算力，是一款面向智能计算与机器人应用的开发板，接口丰富，独特的异构设计可以同时兼顾感知推理和实时运动控制的需求，减少控制系统的体积和复杂度。
...
- 扩展板：[RDK S100 相机扩展板](./03_expansion_board/01_camera/01_rdk_camera_expansion_board.md)、[RDK S100 MCU 接口扩展板](./03_expansion_board/02_mcu/01_rdk_mcu_port_expansion_board.md)
