---
sidebar_position: 1
title: "1.1.1 开发者套件简介（RDK S100）"
description: 1.1.1 开发者套件简介（RDK S100）
slug: /01_Quick_start/01_hardware_introduction/01_rdk_s100/01_rdk_s100_kit
---

# 1.1.1 开发者套件简介（RDK S100）
...
地瓜机器人 RDK S100 系列开发者套件搭载 S100 智能计算芯片，BPU 可提供高达 80/128TOPS 的算力，是一款面向智能计算与机器人应用的开发板，接口丰富，独特的异构设计可以同时兼顾感知推理和实时运动控制的需求，减少控制系统的体积和复杂度。
...
- USB 下载接口。RDK S100 开发板提供的一路下载接口用于固件下载，具体可以参考[1.2 系统烧录](../03_install_os_and_setup/01_instruction.md)
