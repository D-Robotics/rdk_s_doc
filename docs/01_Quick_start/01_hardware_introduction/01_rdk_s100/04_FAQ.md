...
**A: [1.1.1.1 RDK S100 相机扩展板](./02_rdk_s100_camera_expansion_board/01_rdk_s100_camera_expansion_board.md)** 和 **[1.1.1.2 RDK S100 MCU 接口扩展板](./03_rdk_s100_mcu_port_expansion_board.md)** 章节分别有介绍 CAM 子板和 MCU 子板与 RDK S100 主板连接的参考视频可供参考。​
