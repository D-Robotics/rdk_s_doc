...
- USB 下载接口。RDK S100 开发板提供的一路下载接口用于固件下载，具体可以参考[1.2 系统烧录](../../02_install_os/rdk_s100/02_preparation.md)
...
2. 注意[USB 2.0 Camera 接入能力限制](/Basic_Application/Image/usb_camera#usb-2.0-note)。
   :::
...
<img src="https://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/hardware_interface/sw1-2.png" alt="开关" width="70%" />

| 编号 | 名称     | 描述             | 使用方法                         |
| ---- | -------- | ----------------| -------------------------------- |
| SW1  | ON/OFF   | 电源开关         | 向下拨：接通电源<br/>向上拨：关闭电源                |
| SW2  | DOWNLOAD | DFU 烧录模式开关 | 向下拨：正常启动模式<br/>向上拨：开启烧录模式 |
